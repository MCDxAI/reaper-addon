 ...
 * Contains render classes for blocks, beds, anchors with damage display and fading.
 *
...
public class Renderers {
    ...
    /**
     * Bed rendering with damage display and fade effects.
     * Used by BedGod module for bed ESP with damage calculations.
     */
    ...
    /**
     * Anchor rendering with damage display and fade effects.
     * Used by AnchorGod module for anchor ESP with damage calculations.
     */
    ...
    /**
     * Fade-in block rendering (reverse fade effect).
     * Alpha starts at 0 and increases to target alpha over time.
     * Used by various modules for appearing block effects.
     */
    public static class SimpleBlockFadeIn {
        private final BlockPos pos;
        private final Color sideColor1;
        private final Color lineColor1;
        ...
        public void tick() {
            if (ogLine.a > lineColor1.a) lineColor1.a += fadeFactor; // increase the alpha until it equals the 'original' color
