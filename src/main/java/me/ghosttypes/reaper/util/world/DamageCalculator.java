...
/**
 * Damage calculation utilities for bed/anchor combat.
...
public class DamageCalculator {
    ...
    /**
     * Anchor placement data for anchor aura modules.
     */
    ...
    /**
     * Bed placement data for bed aura modules.
     */
    public static class BedPlacement {
        ...
        public BedPlacement() {}
        public BedPlacement(BlockPos bed, CardinalDirection dir, double dmg) {
            this.set(bed, dir, dmg);
        }
        ...
        public void recalculate(PlayerEntity target) {
    ...
    /**
     * Find a bed to break near the target.
     */
    ...
    /**
     * Find optimal bed placement position.
     */
    public static BedPlacement getPlacePos(PlayerEntity target, int xRadius, int yRadius, double range,
                                            double minDmg, double maxDmg, boolean antiSuicide,
                                            boolean groundOnly, BlockSortMode sortMode) {
        if (target == null) return null;
    ...
    /**
     * Get a sphere of positions around a target, sorted by the specified mode.
     */
    ...
    // Distance utilities using cached target
