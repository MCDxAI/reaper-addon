/*
 * This file is part of the Reaper Client distribution (https://github.com/MCDxAI/reaper-addon).
 * Copyright (c) Reaper Development.
 */
...
public class ReaperLongJump extends Module {
    ...
    public ReaperLongJump() {
        super(Reaper.CATEGORY, "reaper-long-jump", "Manipulate movement packets to travel quickly.");
    }
    ...
    private void reset() {
        ...
        // Note: setStepHeight was removed in 1.21.11 - step height is now managed internally
    }
    ...
    private void onMove(PlayerMoveEvent event) {
        if (charged && moved) {
            ...
            // 1.21.11 API: Use getMovementInput() which returns Vec2f(sideways, forward)
            Vec2f movement = mc.player.input.getMovementInput();
            double moveForward = movement.y;
            double moveStrafe = movement.x;
