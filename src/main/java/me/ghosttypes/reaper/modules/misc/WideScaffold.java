...
/**
 * Wide scaffold module for automated block placement in a radius.
 * Places blocks in a wide area below the player with fade rendering.
 *
...
public class WideScaffold extends ReaperModule {
    ...
    public WideScaffold() {
        super(Reaper.CATEGORY, "wide-scaffold", "Scaffold but wider.");
    }
