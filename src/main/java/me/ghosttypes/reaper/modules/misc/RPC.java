...
/**
 * Discord Rich Presence integration for Reaper.
 * Displays custom messages and logo on Discord profile.
 *
 * Ported from 1.19.4 to 1.21.11.
 * Spotify integration removed (see DO_NOT_PORT.md).
 */
public class RPC extends ReaperModule {
    ...
    public RPC() {
        super(Reaper.CATEGORY, "discord-presence-reaper", "Discord RPC for Reaper");
        runInMainMenu = true;
    }
