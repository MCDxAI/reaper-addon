---
description: Analyze changes, generate a commit, and push to the repo
---
...
7. **Commit format**:
   ...
   **IMPORTANT**: Do NOT add any attribution or co-author lines to commits. Keep commits clean and professional.
